package recomovie.userservice.email;
...
import static recomovie.userservice.constants.ErrorConstants.EMAIL_FAIL_TO_SEND;
import static recomovie.userservice.constants.StringConstants.EMAIL_FAILURE;
...
public class EmailService {
    ...
    public void send(String email, String username, String link) {
        try {
            ...
            LOGGER.error(EMAIL_FAILURE, e);
            throw new IllegalStateException(EMAIL_FAIL_TO_SEND);
        }
    }
